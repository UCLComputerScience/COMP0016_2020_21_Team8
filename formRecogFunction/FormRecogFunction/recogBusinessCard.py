        ...
        for eachresult in results:
            if(eachresult.get("RowKey") in phoneCode):  # code, e.g, +1, +44, +374
                if(eachresult.get("Country") == "United States"):
                    # remove +, 1 from number -> leave 3 numbers of code
                    return PhonesWithSameCode("CountriesNumberCodeWith1", "United States", phoneCode[2], phoneCode[3], phoneCode[4], "")
        ...
        if(specificInformation == "All Information"):
            ...
            if contact_names:
                for contact_name in contact_names.value:
                    ...
                    print("Contact First Name: {}".format(
                        contact_name.value["FirstName"].value))
                    print("Contact Last Name: {}".format(
                        contact_name.value["LastName"].value))
