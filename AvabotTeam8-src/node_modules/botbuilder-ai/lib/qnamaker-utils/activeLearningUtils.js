    ...
    static getLowScoreVariation(qnaSearchResults) {
        ...
        if (topAnswerScore > ActiveLearningUtils.MinimumScoreForLowScoreVariation) {
            ...
            for (let i = 1; i < qnaSearchResults.length; i++) {
                if (ActiveLearningUtils.includeForClustering(prevScore, qnaSearchResults[i].score * 100, PreviousLowScoreVariationMultiplier) &&
                    this.includeForClustering(topAnswerScore, qnaSearchResults[i].score * 100, MaxLowScoreVariationMultiplier)) {
