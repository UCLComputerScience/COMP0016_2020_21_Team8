 ...
 */
import { Activity, CoreAppCredentials, BotAdapter, ChannelAccount, ConversationParameters, ConversationReference, ConversationsResult, ExtendedUserTokenProvider, ResourceResponse, TokenResponse, TurnContext, HealthCheckResponse } from 'botbuilder-core';
import { AuthenticationConfiguration, ClaimsIdentity, ConnectorClient, ConnectorClientOptions, AppCredentials, SimpleCredentialProvider, TokenApiClient, TokenStatus, SignInUrlResponse, TokenExchangeRequest } from 'botframework-connector';
 ...
 * ```
 */
export declare class BotFrameworkAdapter extends BotAdapter implements ConnectorClientBuilder, ExtendedUserTokenProvider, RequestHandler {
     ...
     * ```
     */
    createConversation(reference: Partial<ConversationReference>, parameters?: Partial<ConversationParameters> | ((context: TurnContext) => Promise<void>), logic?: (context: TurnContext) => Promise<void>): Promise<void>;
    /**
