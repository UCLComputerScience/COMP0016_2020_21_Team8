...
class EventFactory {
    ...
    static createHandoffInitiation(context, handoffContext, transcript) {
        ...
        const handoffEvent = this.createHandoffEvent(handoffEventNames_1.HandoffEventNames.InitiateHandoff, handoffContext, context.activity.conversation // TODO(joshgummersall) why is this necessary?
        );
